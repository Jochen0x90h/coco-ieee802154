...
struct Drivers {
	...
	UsbHost_native::BulkBuffer bulkReceiveBuffer{bulkEndpoint, Ieee802154Radio::PACKET_LENGTH};
	...
	Ieee802154Radio_usb::Buffer radioReceiveBuffer{node, bulkReceiveBuffer};
};
