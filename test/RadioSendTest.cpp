...
// [0-1]: frame control, [2]: mac counter (gets incremented), [3-4]: pan id (0x0000), [5-6]: short address (0x1337)
uint8_t packetNoAck[] = {0x41, 0x88, 0, 0x00, 0x00, 0x37, 0x13};

// packet with FrameControl::ACKNOWLEDGE_REQUEST
uint8_t packetAck[] = {0x61, 0x88, 50, 0x00, 0x00, 0x37, 0x13};
