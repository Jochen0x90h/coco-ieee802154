...
/// @brief Helper definitions for IEEE 802.15.4
///
...
enum class FrameControl : uint16_t {
    ...
    DESTINATION_ADDRESSING_FLAG = 2 << 10, // flag indicates presence of destination address (short or long)
    ...
    // protocol version
    VERSION_MASK = 3 << 12,
    VERSION_0 = 0 << 12, // IEEE Std 802.15.4-2003

    // source addressing
    SOURCE_ADDRESSING_MASK = 3 << 14,
    SOURCE_ADDRESSING_FLAG = 2 << 14, // flag indicates presence of source address (short or long)
