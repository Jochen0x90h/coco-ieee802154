...
public:
	...
	class Buffer : public coco::Buffer, public LinkedListNode, public LinkedListNode2 {
		friend class Ieee802154Radio_RADIO_TIMER0_EGU0;
	public:
		Buffer(Node &node);
		~Buffer() override;
...
protected:
	...
	// receiver is enabled if at least one receive buffer is queued (in Channel::receiveBuffers)
